...
var $author$project$LinearEquation$init = function (flags) {
	return _Utils_Tuple2(
		_Utils_update(
			$author$project$LinearEquation$initialModel,
			{threshold: flags.threshold, window: flags.window}),
		$author$project$LinearEquation$initialCmd);
};
...
var $author$project$LinearEquation$main = $elm$browser$Browser$element(
	{
		init: $author$project$LinearEquation$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$LinearEquation$update,
		view: $author$project$LinearEquation$view
	});
					...
					return A2(
						...
						function (mastery) {
							return $elm$json$Json$Decode$succeed(
								{mastery: mastery, threshold: threshold, window: window});
						},
						A2($elm$json$Json$Decode$field, 'mastery', $elm$json$Json$Decode$bool));
				},
				A2($elm$json$Json$Decode$field, 'threshold', $elm$json$Json$Decode$int));
		},
		A2($elm$json$Json$Decode$field, 'window', $elm$json$Json$Decode$int)))(0)}});}(this));